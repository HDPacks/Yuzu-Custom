...
#include <memory>
#include "C:/Users/curti/yuzu/src/yuzu/configuration/configure_dialog.h"
...
QT_MOC_LITERAL(4, 40, 17) // "OnLanguageChanged"
    ...
    "ConfigureDialog\0LanguageChanged\0\0"
    "locale\0OnLanguageChanged"
};
...
void ConfigureDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->OnLanguageChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ConfigureDialog::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigureDialog::LanguageChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConfigureDialog::LanguageChanged(const QString & _t1)
{
